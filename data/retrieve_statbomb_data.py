...
statbomb_metrics_needed = [
    ...
    "player_season_pass_forward_ratio","player_season_scoring_contribution_90","player_season_fouls_won_90"
]
...
metrics_mapping = {
    ...
    "player_season_pass_forward_ratio": "Pass Forward %",   # keep your clean label
