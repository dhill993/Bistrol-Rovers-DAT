...
position_mapping = {
    ...
    "Left Attacking Midfielder": "Number 8", "Right Attacking Midfielder": "Number 8", "Right Attacking Midfielder": "Number 8", 
...
def get_statsbomb_player_season_stats():
    ...
    for _, row in all_comps.iterrows():
        try:
            ...
            # Filter only required columns if present
            ...
            print(f"Error loading competition {row['competition_name']} - {row['season_name']}: {e}")
