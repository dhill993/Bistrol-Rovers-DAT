...
statbomb_metrics_needed = [
    ...
    "player_season_pressures_90", "player_season_shots_90", "player_season_xg_90",
    # bolt-on metrics
...
position_mapping = {
    ...
    # OUTSIDE CENTRE BACK (back-three progressors)
...
def retrieve_player_season_stats():
    ...
    for _, row in comps.iterrows():
        ...
        df = df[[c for c in df.columns if c in statbomb_metrics_needed or c in ["League"]]]
