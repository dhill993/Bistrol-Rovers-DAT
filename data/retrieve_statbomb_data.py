...
statbomb_metrics_needed = [
    ...
    "player_season_Pressures_90", "player_season_Counter_Pressures_90", "player_season_defensive_action_regains_90",
    "player_season_defensive_actions_90", "player_season_dribble_faced_ratio", "player_season_dribble_ratio",
    "player_season_dribbles_90", "player_season_np_shots_90", "player_season_np_xg_90",
    "player_season_np_xg_per_shot", "player_season_npg_90", "player_season_npxgxa_90",
    "player_season_obv_90", "player_season_obv_defensive_action_90", "player_season_obv_dribble_carry_90",
    ...
    "player_season_forward_pass_ratio", "player_season_forward_pass_proportion"
]
...
def get_statsbomb_player_season_stats():
    ...
    for i, row in all_comps.iterrows():
        ...
        try:
            ...
            print(e)
    if not dataframes:
        st.warning("No player data was loaded from StatsBomb API. Please check your credentials or API availability.")
        return pd.DataFrame()
