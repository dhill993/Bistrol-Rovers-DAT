...
# Mapping raw SB column names to user-friendly column names
metrics_mapping = {
    'player_name': "Player Name",
    'team_name': 'Team',
    'season_name': "Season",
    'competition_name': 'League',   # <-- important
...
def get_statsbomb_player_season_stats():
    ...
    for i, row in all_comps.iterrows():
        ...
        try:
            ...
            # Convert birth_date and calculate Age
            ...
            # Replace NaN-like values with 0 and ensure numeric columns where applicable
    ...
    # Debug print to verify columns exist
    print("Columns in final DataFrame:", final_dataframe.columns.tolist())
